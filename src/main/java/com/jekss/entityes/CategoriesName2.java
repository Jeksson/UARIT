 ...
 */
@Entity
@Table(name = "categoriesname2")
public class CategoriesName2 extends BaseClass implements Serializable {
    private int id_categories;
    private String name_categories;

    public CategoriesName2() {
    }
    ...
    public boolean equals(Object o) {
        ...
        CategoriesName2 that = (CategoriesName2) o;
