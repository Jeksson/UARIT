 ...
 */
@Entity
@Table(name = "categoriesname3")
public class CategoriesName3 extends BaseClass implements Serializable {
    private int id_categories;
    private String name_categories;

    public CategoriesName3() {
    }
    ...
    public boolean equals(Object o) {
        ...
        CategoriesName3 that = (CategoriesName3) o;
