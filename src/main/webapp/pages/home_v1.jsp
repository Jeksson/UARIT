...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/pages/css/flexslider.css"
          media="screen">
            ...
            <div id="top-header">
                ...
                <div class="row">
                    ...
                    <nav id="top-navigation" class="col-lg-7 col-md-7 col-sm-7">
                        <ul class="pull-left">
                            <li><a href="${pageContext.request.contextPath}/pages/create_an_account.jsp">Мой акаунт</a>
                            </li>
                            <li><a href="${pageContext.request.contextPath}/pages/orders_list.html">Список заказов</a>
                            </li>
                                ...
                                <ul id="login-dropdown" class="box-dropdown">
                                    <li>
                                        <div class="box-wrapper">
                                            ...
                                            <input type="checkbox" id="loginremember"> <label for="loginremember">Запомнить
                                            меня</label>
                                            <br>
                                            <br>
                                            <div class="pull-left">
                                        ...
                                        <div class="footer">
                                            ...
                                            <a class="button pull-right"
                                               href="${pageContext.request.contextPath}/register">Создать аккаунт</a>
                                        </div>
                                    </li>
                                </ul>
                            </li>
                            <li><a href="${pageContext.request.contextPath}/register"><i
                                    class="icons icon-lock"></i> Создать аккаунт</a></li>
                        </ul>
                    </nav>
            ...
            <div id="main-header">
                ...
                <div class="row">
                    ...
                    <nav id="middle-navigation" class="col-lg-8 col-md-8 col-sm-8">
                        <ul class="pull-right">
                            <li class="blue">
                                <a href="${pageContext.request.contextPath}/pages/compare_products.html"><i
                                        class="icons icon-docs"></i>0 Items</a>
                            </li>
                            <li class="red">
                                <a href="${pageContext.request.contextPath}/pages/wishlist.html"><i
                                        class="icons icon-heart-empty"></i>2 Items</a>
                            </li>
                            <li class="orange"><a href="${pageContext.request.contextPath}/pages/order_info.html"><i
                                    class="icons icon-basket-2"></i>17 Items</a>
                        ...
                        <div>
                            ...
                            <div class="product">
                                ...
                                <div class="product-image">
                                    <img src="http://www.microtron.ua/pictures/products_pictures/119/picorig_119709.jpg"
                                         alt="Product1">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12">
                    ...
                    <div class="sidebar-box-content">
                        <table class="bestsellers-table">
                            ...
                            <tr>
                                <td class="product-thumbnail"><a href="#"><img src="img/products/sample1.jpg"
                                                                               alt="Product1"></a></td>
                            ...
                            <tr>
                                <td class="product-thumbnail"><a href="#"><img src="img/products/sample2.jpg"
                                                                               alt="Product1"></a></td>
                                <td class="product-info">
                                    <p><a href="#">Lorem ipsum dolor sit amet</a></p>
                                    <span class="price">$550.00</span>
                            ...
                            <tr>
                                <td class="product-thumbnail"><a href="#"><img src="img/products/sample3.jpg"
                                                                               alt="Product1"></a></td>
                                <td class="product-info">
                                    <p><a href="#">Lorem ipsum dolor sit amet</a></p>
                                    <div class="rating readonly-rating" data-score="4"></div>
