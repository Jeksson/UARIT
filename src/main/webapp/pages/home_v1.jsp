...
<html>
    ...
    <head>
		...
		<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/pages/css/bootstrap.min.css">
		<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/pages/css/perfect-scrollbar.css">
		<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/pages/css/style.css">
		<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/pages/css/flexslider.css" media="screen">
		<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/pages/css/fontello.css">
		<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/pages/css/settings.css" media="screen">
		<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/pages/css/animation.css">
		<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/pages/css/owl.carousel.css">
		<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/pages/css/owl.theme.css">
		<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/pages/css/chosen.css">
					...
					<div id="main-header">
						...
						<div class="row">
							...
							<div id="logo" class="col-lg-4 col-md-4 col-sm-4">
								<a href="home_v1.jsp"><img src="${pageContext.request.contextPath}/pages/img/logo.png" alt="Logo"></a>
							</div>
							
							<nav id="middle-navigation" class="col-lg-8 col-md-8 col-sm-8">
								<ul class="pull-right">
									<li class="blue">
										<a href="${pageContext.request.contextPath}/pages/compare_products.html"><i class="icons icon-docs"></i>0 Items</a>
                                    </li>
									<li class="red">
										<a href="${pageContext.request.contextPath}/pages/wishlist.html"><i class="icons icon-heart-empty"></i>2 Items</a>
                                    </li>
									<li class="orange"><a href="${pageContext.request.contextPath}/pages/order_info.html"><i class="icons icon-basket-2"></i>17 Items</a>
							...
							<div class="tp-banner" >
								<ul>
									...
									<li data-transition="fade" data-slotamount="7" data-masterspeed="1500" >
										<!-- MAIN IMAGE -->
										<img src="http://www.microtron.ua/pictures/products_pictures/113/picorig_113228.jpg"  alt="slidebg1"  data-bgfit="cover" data-bgposition="left top" data-bgrepeat="no-repeat">
										<!-- LAYERS -->
									...
									<li data-transition="zoomout" data-slotamount="7" data-masterspeed="1000" >
										<!-- MAIN IMAGE -->
										<img src="http://www.microtron.ua/pictures/products_pictures/108/picorig_108156.jpg"  alt="darkblurbg"  data-bgfit="cover" data-bgposition="left top" data-bgrepeat="no-repeat">
										<!-- LAYERS -->
										<div class="tp-caption skewfromrightshort fadeout"
											data-x="40"
											data-y="60"
									...
									<li data-transition="zoomout" data-slotamount="7" data-masterspeed="1000" >
										<!-- MAIN IMAGE -->
										<img src="http://www.microtron.ua/pictures/products_pictures/112/picorig_112488.jpg"  alt="darkblurbg"  data-bgfit="cover" data-bgposition="left top" data-bgrepeat="no-repeat">
										<!-- LAYERS -->
										<div class="tp-caption skewfromrightshort fadeout"
											data-x="40"
											data-y="60"
									...
									<div>
										...
										<div class="product">
											...
											<div class="product-image">
												<img src="http://www.microtron.ua/pictures/products_pictures/119/picorig_119709.jpg" alt="Product1">
									...
									<div>
										...
										<div class="product">
											...
											<div class="product-image">
												...
												<img src="http://www.microtron.ua/pictures/products_pictures/125/picorig_125836.jpg
" alt="Product1">
												<a href="products_page_v1.html" class="product-hover">
													<i class="icons icon-eye-1"></i> Quick View
												</a>
									...
									<div>
										...
										<div class="product">
											...
											<div class="product-image">
												<img src="http://www.microtron.ua/pictures/products_pictures/109/picorig_109839.jpg
" alt="Product1">
												<a href="products_page_v1.html" class="product-hover">
													<i class="icons icon-eye-1"></i> Quick View
												</a>
									...
									<div>
										...
										<div class="product">
											...
											<div class="product-image">
												<img src="http://www.microtron.ua/pictures/products_pictures/90/picorig_90663.jpg
" alt="Product1">
												<a href="products_page_v1.html" class="product-hover">
													<i class="icons icon-eye-1"></i> Quick View
												</a>
										...
										<ul class="sidebar-dropdown">
											<li>
												<ul>
													...
													<li><a href="#">Аксесуары для планшетов</a></li>
