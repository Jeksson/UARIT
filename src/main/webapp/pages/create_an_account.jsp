			...
			<jsp:include page="_header.jsp"/>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12">
                	<div class="breadcrumbs">
                    	<p><a href="${pageContext.request.contextPath}/">Home</a> <i class="icons icon-right-dir"></i> Create an account</p>
                    </div>
                </div>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 register-account">
                            ...
                            <div class="page-content">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12">
                                    	<input class="big" type="submit" value="Зарегестрироваться">
